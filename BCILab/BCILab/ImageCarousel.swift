...
//            }
    ...
    func appendImages(_ name: String, label: ImageLabels)  {
...
struct ImageCarouselRep: UIViewRepresentable {
    ...
    func makeUIView(context: Context) -> ImageCarouselView {
        ...
        newView.appendImages("Faces", label: ImageLabels.face)
        newView.appendImages("NonFaces", label: ImageLabels.nonface)
        newView.prepare()
