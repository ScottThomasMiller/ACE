...
//    }
//    
//    // Function pullChunk added by Scott Miller for Aeris Rising, LLC on 8/15/21
//    func pullChunk(_ buffers: inout [Float32], _ timestamps: inout [Double]) throws -> Int {
//        guard streamInfo.channelFormat == .float32 else { throw Error.argument }
//        var error: Int32 = 0
//        let buffCount = (MAXSAMPLES * UInt(NUMCHANNELS))
//
//        let numElements = Int(lsl_pull_chunk_f(base, &buffers, &timestamps, buffCount, MAXSAMPLES, 10.0, &error))
//        if error != 0 {
//            throw Error(rawValue: error)!
//        }
//
//        let numSamples = numElements / NUMCHANNELS
//        return numSamples
//    }
//    
